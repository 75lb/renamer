module.exports = [
  ...
  },
  {
    ...
    type: String,
    defaultValue: '',
    description: "The replace string. With --regex set, --replace can reference parenthesised substrings from --find with $1, $2, $3 etc. If omitted, defaults to a blank string. The special token '{{index}}' will insert an incrementing number per file processed. The special token '{{indexZeroPrefixed}}' will insert an incrementing number prefixed by zeros."
  },
  {
    name: 'regex',
    type: Boolean,
