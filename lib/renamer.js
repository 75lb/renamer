...
Renamer.prototype._renameFile = function(result, index, resultsSoFar){
    ...
    // var existing = resultsSoFar.filter(function(prevResult){
    //     return prevResult.after === after;
    // });
    ...
    // if (existing.length || fs.existsSync(result.after)){
...
Renamer.prototype._dryRun = function(result, index, resultsSoFar){
    var existing = resultsSoFar.filter(function(prevResult, prevIndex){
        // console.dir(prevResult.before + ": " + result.before + ", " + prevResult.after + ": " + result.after)
